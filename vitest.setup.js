/**
 * Vitest Setup File — mocks Electron APIs so test suites can import store.js
 * and other Electron-dependent modules without crashing.
 */
...
vi.mock("electron-store", () => {
    ...
    return {
        default: class ElectronStore {
            constructor(opts = {}) {
                this.opts = { projectName: "refinzi", ...opts };
                this._data = new Map();
            }
            get(key, def) {
