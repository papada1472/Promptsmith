...
export function ThemeToggle({ theme = "dark", onToggleTheme, className = "" }) {
  ...
  return (
    <button
      ...
      className={`relative inline-flex h-8 w-8 items-center justify-center rounded-lg border border-white/10 bg-zinc-900/80 text-zinc-300 hover:text-white hover:border-white/20 hover:bg-zinc-800 transition-all cursor-pointer shadow-sm ${
